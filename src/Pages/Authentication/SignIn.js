    ...
    return (
        <div className='min-h-screen text-white mx-60 mt-32'>
            <section class="min-h-screen flex items-stretch text-white ">
                <div class="background lg:flex w-1/2 hidden bg-gray-500 bg-no-repeat bg-cover relative items-center">
                ...
                <div class="background-color lg:w-1/2 w-full flex items-center justify-center text-center md:px-16 px-0 z-0">
                    <div class="background absolute lg:hidden z-10 inset-0 bg-gray-500 bg-no-repeat bg-cover items-center">
                        <div class="absolute bg-black opacity-60 inset-0 z-0"></div>
                    </div>
